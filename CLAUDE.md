...
- **3D:** Valley Trig STEPs (`3D Files/fwstpfiles`) are redundant with Neal's set — don't swap (HA files 3–4× heavier); ask Valley for 36-deep U-base. Primary corner-mount legs (`fwcornermountingplate`, 4 STEPs, raw GLBs beside them) are legit — NOT on Neal's list. Neal email `r-5171940364273443650` still unsent, send as-is.

...
**Repos:** tablex-site `main` = `9a4355c` (prod ● live-verified, auto-deploys from `main`). Dashboard `main` = `92f78c7` (Vercel hub `danny@clearph.com`, repo `github.com/dbreck/tablex-quoting-dashboard`).

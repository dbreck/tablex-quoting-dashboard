...
**Repos:** tablex-site `main` = `5f7fbd3` (prod ● live-verified, auto-deploys from `main`). Dashboard `main` = `2344531` (Vercel hub `danny@clearph.com`, repo `github.com/dbreck/tablex-quoting-dashboard`).

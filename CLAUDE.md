...
- **⚠ Standing-ruling correction:** the MiA footer seal + `/about/made-in-america` are BACK (`d1b97b6`, Brian 9/01 reversal of `dec-family-owned`; seal footer-only, unlinked). `/about/family-owned` still exists. The "MADE-IN-AMERICA IS RETIRED" ruling below is stale for the footer mark.

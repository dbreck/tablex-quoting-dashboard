...
export const LABELS = [
  ...
  { id: "design-system", name: "Design System", color: "#d946ef" },
  { id: "devops", name: "DevOps", color: "#f59e0b" },
  { id: "infra", name: "Infra", color: "#71717a" },
  { id: "content", name: "Content", color: "#06b6d4" },
  { id: "ia", name: "IA", color: "#14b8a6" },
  { id: "media", name: "Media", color: "#f43f5e" },
  { id: "motion", name: "Motion", color: "#f97316" },
  { id: "pm", name: "PM", color: "#eab308" },
  { id: "comms", name: "Comms", color: "#0ea5e9" },
  { id: "client", name: "Client", color: "#6366f1" },
  { id: "admin", name: "Admin", color: "#64748b" },
  { id: "billing", name: "Billing", color: "#10b981" },
  { id: "ritual", name: "Ritual", color: "#22c55e" },
  { id: "setup", name: "Setup", color: "#525252" },
  { id: "cleanup", name: "Cleanup", color: "#84cc16" },
  { id: "artifact", name: "Artifact", color: "#78716c" },
  { id: "phase-2", name: "Phase 2", color: "#a855f7" },
  { id: "rollover", name: "Rollover", color: "#b45309" },

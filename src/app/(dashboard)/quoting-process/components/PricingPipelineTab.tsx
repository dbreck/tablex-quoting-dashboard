...
export function PricingPipelineTab({ profitData }: { profitData: ProfitRow[] }) {
  ...
  const row = useMemo(
    () =>
      (profitData.find((r) => r.sku === selectedSku) ||
  ...
  return (
    <div>
      {/* Info bar with Full Overview dialog */}
      <div className="mb-6 flex items-center justify-between gap-4 p-3 rounded-xl bg-slate-50 border border-slate-200">

  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        canStartNow: "blocked",
        blockerReason:
          "Requires either a seat on TableX's Adobe CC or a new $50/yr Adobe Portfolio subscription.",
        handoffRequired: true,
        handoffNotes:
          "Ideal: TableX provides an Adobe CC seat. Fallback: Clear pH purchases Portfolio and expenses it.",
        costNote: "$0 if TableX has CC, else $50/yr",
        steps: [
          { id: "check", label: "Confirm with Brian whether TableX has Adobe CC", blockedOnClient: true },
          { id: "license", label: "Get CC seat or buy Portfolio plan", blockedOnClient: true },
          { id: "typefaces", label: "Finalize typefaces during web-2a style guide phase" },
          { id: "web-project", label: "Create Adobe Fonts web project for the domain" },
